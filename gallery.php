<?php
	...
	*/
	...
	define('SECURITY_PHRASE', 'qwerty12345zoerwasherethisissparta');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
	...
	define('TEXT_GALLERY_NAME', 'Галерея');
	define('TEXT_BANNER', '');
	define('TEXT_HOME', 'Главная');
	define('TEXT_CLOSE_IMG_VIEW', 'Закрыть');
	define('TEXT_ACTUAL_SIZE', 'Размер');
	define('TEXT_FULLRES', 'Полное разрешение');
	define('TEXT_PREVIOUS', '<< Предыдущая');
	define('TEXT_NEXT', 'Следуйщая >>');
	define('TEXT_INFO', 'Информация');
	define('TEXT_DOWNLOAD', 'Скачать');
	define('TEXT_SLIDESHOW', 'Слайдшоу');
	define('TEXT_NO_IMAGES', 'Нет изображений в галереи');
	define('TEXT_DATE', 'Дата');
	define('TEXT_FILESIZE', 'Разрешение');
	define('TEXT_IMAGESIZE', 'Полное Изображение');
	define('TEXT_DISPLAYED_IMAGE', 'Displayed Image');
	define('TEXT_DIR_NAME', 'Название галереи');
	define('TEXT_IMAGE_NAME', 'Название файла');
	define('TEXT_FILE_NAME', 'Имя файла');
	define('TEXT_DIRS', 'Путь');
	define('TEXT_IMAGES', 'Изображения');
	define('TEXT_IMAGE_NUMBER', 'Номер');
	define('TEXT_FILES', 'Файлы');
	define('TEXT_DESCRIPTION', 'Описание');
	define('TEXT_DIRECT_LINK_GALLERY', 'Сылка на галерею');
	define('TEXT_DIRECT_LINK_IMAGE', 'Сылка на изображение');
	define('TEXT_NO_PREVIEW_FILE', 'Предпросмотр запрещён');
	define('TEXT_IMAGE_LOADING', 'Изображение загружаеться ');
	define('TEXT_LINKS', 'Сылки');
	define('TEXT_NOT_SCALED', 'Без увеличения');
	define('TEXT_LINK_BACK', 'Вернуться на сайт');
	define('TEXT_THIS_IS_FULL', 'Full');
	define('TEXT_THIS_IS_PREVIEW', 'Preview');
	define('TEXT_SCALED_TO', 'Увеличение');
	define('TEXT_YES', 'ДА');
	define('TEXT_NO', 'Нет');
	define('TEXT_FIRST_VIEW', 'This is first view of this image. Refresh page to get information.');

	define('TEXT_LOGIN', 'Логин');
	define('TEXT_LOGOUT', 'Выйти');
	...
	define('TEXT_MKDIR', 'Создать папку');
	define('TEXT_UPLOAD', 'Загрузить');
	define('TEXT_NOTHING', 'Нет выбраных');
	define('TEXT_ONLY_ONE', 'Выбери только один елемет для этой функции');
	define('TEXT_ONE_IMAGE', 'Выбери только одно изображение для функции');
	...
	{
		echo '<!DOCTYPE html><html><head><meta charset="'.CHARSET.'">
		<div id="dataContainer"><br>'.
	...
	else
	{
		...
		'<a href="/" style="left: 20px;position: absolute;top: 20px;">
<img border="0" alt="W3Schools" src="images/backbutton.png" width="100" height="100">
		</a>';
